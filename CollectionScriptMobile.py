...
def get_ad_info(driver, movie_id):
    ...
    print("Ad Paused! How much ad has played (s): ",current_time)
    driver.execute_script(
    ...
    time.sleep(5)
    driver.execute_script(
        "return document.getElementsByClassName('video-stream html5-main-video')[0].play()"
    )
    ...
    print("Ad Playing! How much ad has progressed: ",new_time)
    skip_retry = 0
    time.sleep(0.1)
    while skip_retry < 20:
    ...
    print("Ad Resolution: ", start_resolution)
...
def get_ad_duration(driver):
    ...
    while length_retry < 50:
        try:
            ad_length = driver.execute_script(
            ...
            while True:
                ...
                if ad_playing:
                    ...
                    video_info_details["Main_Video"] = {
                        ...
                        "AvgBuffer": (
                            sum(actual_buffer_reads) / len(actual_buffer_reads)
                        ),
                        "Resolution": Main_res,
                    }
...
def driver_code(driver):
    list_of_urls = ["https://www.youtube.com/watch?v=R8mUqP1sToA"]
